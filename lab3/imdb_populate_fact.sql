...
from Title_Rating_Facts_Appalling full outer join Title_Rating_Facts_Average
full outer join Title_Rating_Facts_Outstanding;

create table Title_Rating_Facts as 
select *
from Title_Rating_Facts_Appalling appal full outer join Title_Rating_Facts_Average avg;
